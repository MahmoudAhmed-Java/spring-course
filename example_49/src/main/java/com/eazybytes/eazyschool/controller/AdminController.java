...
public class AdminController {
    ...
    public ModelAndView addNewClasses(Model model , @ModelAttribute("eazyClass") EazyClass eazyClass ){
    ...
    public ModelAndView deleteClass(Model model , @RequestParam(name = "id") int id) {
    ...
    public ModelAndView deleteStudentFromCourse(Model model , @RequestParam int personId , HttpSession httpSession){
        ...
        ModelAndView modelAndView
                = new ModelAndView("redirect:/admin/viewStudents?id="+courses.getCourseId());
        return modelAndView;
    }
